...
const Dashboard = ({ onLogout }: { onLogout: () => void }) => {
  ...
  const [isAdmin, setIsAdmin] = useState(false); // 👈 IMPORTANT
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6 mt-5">
              ...
              <div className="flex gap-3">
                ...
                <input
                  ...
                  min={1}
                  max={5}
                  className="border border-gray-300 rounded-lg px-4 py-2 w-20 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={rating}
